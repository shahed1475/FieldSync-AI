...
exports.ontologyBuilder = exports.OntologyBuilder = void 0;
...
class OntologyBuilder {
     ...
     */
    async build(policyInputs, options = {}) {
     ...
     */
    async buildPolicy(input, options) {
     ...
     */
    async buildSOP(policyId, input, index, options) {
        ...
        for (const sectionInput of input.sections) {
            const section = await this.buildSection(sopId, sectionInput, sectionIndex, options);
     ...
     */
    async buildSection(sopId, input, index, options) {
        ...
        for (const stepInput of input.steps) {
            const step = await this.buildStep(sectionId, stepInput, stepIndex, options);
     ...
     */
    async buildStep(sectionId, input, index, options) {
     ...
     */
    buildClause(stepId, input, index) {
     ...
     */
    generateId(type, parentId, index) {
